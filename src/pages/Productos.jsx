...
export default function Productos() {
  ...
  useEffect(() => {
    document.title = "Tienda de pedales musicales | Productos";
    ...
    updateMetaTag(
      "description",
      "Explora el catálogo de pedales de música. Encuentra pedales toda la variedad disponible en un solo lugar."
    );
    updateMetaTag(
      "keywords",
      "pedales de musica, pedales de guitarra, pedales de bajo, pedales multiefecto"
    );
    updateMetaTag("author", "@webmaster");
    updateMetaTag("robots", "index, follow");

    updateMetaTag("og:title", "Tienda de pedales músicales", "property");
    updateMetaTag(
      "og:description",
      "Explora el catálogo de pedales músicales.",
      "property"
    );
